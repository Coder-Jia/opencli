...
import { navigateToImagine, fillPrompt, clickGenerate, buildMjPrompt, snapshotImageUrls, waitForNewImages, } from './utils.js';
cli({
    site: 'midjourney',
    name: 'imagine',
